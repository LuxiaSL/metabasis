...
Run (from pipeline/):
  python -m metabasis.scripts.a8_rosetta --selftest     # synthetic mechanics
  python -m metabasis.scripts.a8_rosetta --inventory    # axis registry load check
  python -m metabasis.scripts.a8_rosetta                 # real suite (post CP-2)
"""
...
from metabasis.scripts.a8_fit_g import (
...
# ---------------------------------------------------------------- selftest
def selftest() -> int:
    from metabasis.scripts.a8_fit_g import _synthetic_world, _selftest_split, run_pair_arm
