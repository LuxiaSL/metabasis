...
Run (repo root): PYTHONPATH=pipeline python -m metabasis.scripts.a8_smalls_curverows
"""
...
from metabasis.scripts.a8_rosetta import (
...
def delta_series(family: str = PRIMARY_FAMILY) -> dict:
    ...
    from metabasis.scripts.a8_rosetta import _load_key
    out: dict = {}
