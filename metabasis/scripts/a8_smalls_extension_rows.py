...
Run (repo root):
  PYTHONPATH=pipeline python -m metabasis.scripts.a8_smalls_extension_rows --phase predict
  PYTHONPATH=pipeline python -m metabasis.scripts.a8_smalls_extension_rows --phase verify
"""
...
from metabasis.scripts.a8_smalls_star_systems import (
