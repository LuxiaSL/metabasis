...
Run (repo root):
  PYTHONPATH=pipeline python -m metabasis.scripts.a8_smalls_olmo_readout
"""
...
from metabasis.scripts.a8_rosetta import TOP_PC_J, _unit, cos, load_axes
from metabasis.scripts.a8_smalls_star_systems import RANK_GUARD_DIVISOR, V7, _load_v7, _n_train
