...
logger = logging.getLogger("build_injection_banks")
...
def build_target(target: str, cfg: dict) -> None:
    ...
    stamp = {
        ...
        "prereg_tag": "prereg-arm8-v1", "builder": "build_injection_banks.py",
        "date": "2026-07-22", "target": target, "inject_site": site,
        "fit_file": str(cfg["fit"]), "fit_sha256": _sha(cfg["fit"]),
        "source_registry": f"read_transported_axes.load_axes('{cfg['source']}') — recipe-level sign "
