...
from metabasis.scripts.read_transported_axes import _load_key, _unit, cos, load_axes

logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")
logger = logging.getLogger("difficulty_curve_rows_dsv2")
...
def main() -> int:
    ...
    doc = {
        ...
        "prereg_tag": "prereg-arm8-v1", "builder": "difficulty_curve_rows_dsv2.py",
