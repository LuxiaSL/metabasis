...
from metabasis.scripts.trait_probe import PROMPTS

logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")
logger = logging.getLogger("owl_state_column")
...
def chat_ids(tok, user: str, completion: str) -> tuple[list[int], int]:
    """Same id construction as collect_mean_states.build_ids (native arm)."""
